...
<form action="add_quiz_process.php" method="post">
    ...
    <div id="questions">
        <div class="question">
            ...
            <input type="radio" name="correct_answers[0]" value="0" required> Correct<br>
            Answer 2: <input type="text" name="answers[0][1]" required>
            <input type="radio" name="correct_answers[0]" value="1" required> Correct<br>
            Answer 3: <input type="text" name="answers[0][2]" required>
            <input type="radio" name="correct_answers[0]" value="2" required> Correct<br><br>
        </div>
    </div>
